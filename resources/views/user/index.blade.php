    ...
    <header class="bg-white ">
        <div class="flex items-center justify-between">
            ...
            <nav id="navbar" class="hidden  md:flex items-center space-x-12 gap-14">
                ...
                <a href="{{ url('/ong') }}" class="text-customBlue text-2xl font-itim hover:text-purple-900 hover:underline hover:pb-3">ONG's</a>
        ...
        <div id="mobile-menu" class="hidden bg-white  py-2 px-4 ">
            ...
            <a href="/user/ongs" class="text-customBlue text-2xl font-itim hover:text-purple-900 hover:underline hover:pb-3">ONG's</a>
            <a href="{{ url('/donates')}}#doacao" class="block text-customBlue text-lg font-itim py-2 hover:text-purple-900">Parceirias</a>
